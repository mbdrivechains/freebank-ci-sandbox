...
* bitcoin.conf: contains configuration settings for freebankd or bitcoin-qt
* freebankd.pid: stores the process id of freebankd while running
...
* debug.log: contains debug information and general logging generated by freebankd or bitcoin-qt
