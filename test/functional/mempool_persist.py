...
By default, freebankd will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give freebankd a second to reload the mempool
        ...
        self.log.debug("Prevent freebankd from writing mempool.dat to disk. Verify that `savemempool` fails")
