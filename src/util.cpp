...
const char * const BITCOIN_CONF_FILENAME = "freebank.conf";
const char * const BITCOIN_PID_FILENAME = "freebankd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "FreeBank";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/FreeBank";
#else
    // Unix
    return pathRet / ".freebank";
#endif
#endif
}
